(function () {
  ...
  // Scores an item against the query words: words found in the title weigh
  // more than ones only found in description/tags/category. Returns null if
  // even a single word isn't present in any field (an "AND" match, not "OR").
